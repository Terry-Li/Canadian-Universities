...
public class TextBoxes
{
    ...
    private static void printTextBoxes(Box root)
    {
        ...
        else if (root instanceof ElementBox)
        {
            ...
            if (el.getElement().getTagName().equalsIgnoreCase("img")){
                //System.out.println(el.getElement().getAttribute("alt"));
            }
    ...
    {
        String input = "http://www.cs.uic.edu/Main/Faculty";
        
        try {
            //Open the network connection 
            DocumentSource docSource = new DefaultDocumentSource(input);
