...
public class CSSModel {
    ...
    public static ArrayList<Person> getPersons(String url)
    {
        ...
        try {
            ...
            //Display the result
          if(url!=null)
          PersonInfo(browser.getViewport(), Persons); 
            docSource.close();
    ...
    private static void PersonInfo(Box root, ArrayList<Person> Persons)
    {   
        if (root instanceof TextBox)
        {
            TextBox text = (TextBox) root;
            Person c = new Person(text.getText(),text.getAbsoluteBounds().x,text.getAbsoluteBounds().y,text.getParent().getElement().getTagName(),text.getWidth(),text.getHeight(),text.getParent().getElement().getTagName());
        ...
        else if (root instanceof ElementBox)
        {
            ElementBox el = (ElementBox) root;
            for (int i = el.getStartChild(); i < el.getEndChild(); i++)
            	PersonInfo(el.getSubBox(i), Persons);
        }
    }
}
